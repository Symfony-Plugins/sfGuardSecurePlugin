...
class sfGuardSecureFormSignin extends BasesfGuardFormSignin
{
   public function configure()
   {
    ...
    protected function checkSecurityAttack()
    {
        ...
        $login_failure_time_window           = sfConfig::get('app_sf_guard_secure_plugin_login_failure_time_window', 60); 
